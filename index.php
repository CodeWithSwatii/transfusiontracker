...
<head>
    ...
    <style>
        body {
            background-image: url("a1111.png");
...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php"><i class="icofont-blood-drop"></i>TRANSFUSION TRACKER</a>
        </div>
...
<div class="container">
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                ...
                                <div class="g-recaptcha" data-sitekey="6LcojkQmAAAAAPwl3-HNLFIyKvSMx3UxTrKEjrpb"></div>
			...
			<?php
				if (isset($_POST['login'])) {
                    ...
                    $data = array(
                        'secret' => '6LcojkQmAAAAAO4ACNtZYXJOcn5vsIco2ezLi7y7',
	...
	<footer class="page-footer font-small special-color-dark pt-4">
		...
		<div class="footer-copyright text-center py-3">© <?php echo date("Y"); ?>
		 Developed By Swati, Suryanshi, Yashmitha |
         Contact us: 9876767676 Email: transfusion@gmail.com
		</div>
		<!-- Copyright -->
